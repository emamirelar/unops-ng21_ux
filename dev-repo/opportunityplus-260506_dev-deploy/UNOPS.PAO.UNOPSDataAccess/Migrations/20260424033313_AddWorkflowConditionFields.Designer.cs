...
namespace UNOPS.PAO.UNOPSDataAccess.Migrations
{
    ...
    [Migration("20260424033313_AddWorkflowConditionFields")]
    partial class AddWorkflowConditionFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UNOPS.PAO.Domain.Entities.Office", b =>
                {
                    ...
                    b.Property<int?>("ParentOrganizationHierarchyId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("ParentOrganizationHierarchyId");

                    b.ToTable("Offices", "public");
                });

            modelBuilder.Entity("UNOPS.PAO.Domain.Entities.OfficeRelationship", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("EntityId", "EntityType", "OfficeId")
                        .IsUnique();

                    b.ToTable("OfficeRelationships", "public");
                });
            ...
            modelBuilder.Entity("UNOPS.PAO.UNOPSDomain.Entities.WorkflowConditionField", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("WorkflowConditionFields", "public");
                });
            ...
            modelBuilder.Entity("UNOPS.PAO.Domain.Entities.Office", b =>
                {
                    ...
                    b.HasOne("UNOPS.PAO.Domain.Entities.OrganizationHierarchy", "ParentOrganizationHierarchy")
                        .WithMany()
                        .HasForeignKey("ParentOrganizationHierarchyId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.Navigation("OrganizationHierarchy");

                    b.Navigation("ParentOrganizationHierarchy");
                });

            modelBuilder.Entity("UNOPS.PAO.Domain.Entities.OfficeRelationship", b =>
                {
                    b.HasOne("UNOPS.PAO.Domain.Entities.Office", "Office")
                        .WithMany("OfficeRelationships")
                        .HasForeignKey("OfficeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("UNOPS.PAO.Domain.Entities.Opportunity", b =>
                {
                    ...
                    b.HasOne("UNOPS.PAO.Domain.Entities.Office", "ResponsibleOrgUnit")
                        .WithMany()
            ...
            modelBuilder.Entity("UNOPS.PAO.Domain.Entities.Office", b =>
                {
                    b.Navigation("OfficeRelationships");
                });
