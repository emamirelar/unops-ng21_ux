...
def generate_interaction_from_event_seeder(csv_file_path: str, output_file_path: str) -> None:
    ...
    for event in events:
        ...
        # New interaction
        gmail_message_id = clean_field(event.get('Id', ''))
...
{chr(10).join(interaction_tuples)}
    ...
    try:
        ...
        print(f"Successfully generated InteractionFromEventSeeder.cs")
...
def main():
    ...
    csv_file = os.path.join(script_dir, "Events_20251009 - Sheet2.csv")
    output_file = os.path.join(script_dir, "..", "..", "..", "UNOPS.PAO.UNOPSDataAccess", "Seed", "Seeders", "InteractionFromEventSeeder.cs")
    
    print("InteractionFromEventSeeder Generator")
    print("=" * 50)
    ...
    # Generate the seeder
    generate_interaction_from_event_seeder(csv_file, output_file)
