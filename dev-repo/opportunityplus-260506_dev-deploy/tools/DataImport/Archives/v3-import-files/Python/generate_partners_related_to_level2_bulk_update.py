...
if __name__ == "__main__":
    ...
    csv_file = os.path.join(script_dir, "..", "CSV", "Partners_Related_To_Level2 - Sheet1.csv")
    ...
    output_file = os.path.join(project_root, "UNOPS.PAO.UNOPSDataAccess", "Seed", "Seeders", "Partners_Related_To_Level2_Bulk_Update.cs")
