...
def process_csv_and_generate_seeder(csv_file_path, output_cs_file_path):
    """
    Process the Partners CSV file and generate C# seeder code to update Partner records
    ...
    with open(csv_file_path, 'r', encoding='utf-8') as csvfile:
        ...
        for row in reader:
            erp_dim_value = row.get('ErpDimValue', '').strip()
...
if __name__ == "__main__":
    ...
    csv_file = os.path.join(script_dir, "..", "CSV", "Partners_Related_To_Level4 - Sheet1.csv")
    ...
    output_file = os.path.join(project_root, "UNOPS.PAO.UNOPSDataAccess", "Seed", "Seeders", "Partners_Related_To_Level4_Bulk_Update.cs")
