...
if __name__ == "__main__":
    ...
    csv_file = os.path.join(script_dir, "..", "CSV", "PartnerTreeBulkUpdate_20251202 - Level4.csv")
    ...
    output_file = os.path.join(project_root, "UNOPS.PAO.UNOPSDataAccess", "Seed", "Seeders", "PartnerTree_Bulk_Update_Level4.cs")
