        ...
        <div class="flex flex-col gap-6">
            ...
            <div class="flex flex-col gap-3">
                <p-iconfield class="w-full sm:w-72">
                    ...
                    <input pInputText [ngModel]="searchQuery()" (ngModelChange)="searchQuery.set($event)" placeholder="Search opportunities..." class="w-full" />
                </p-iconfield>

                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
                    <div class="flex items-center flex-wrap gap-2">
                        <p-tag [value]="filteredOpportunities().length + ' Opportunities'" icon="pi pi-briefcase" severity="secondary" />
                        <p-tag [value]="idProfileCount() + ' ID &amp; Profile'" icon="pi pi-info-circle" severity="secondary" />
                        <p-tag [value]="formulationCount() + ' Formulation'" icon="pi pi-pencil" severity="secondary" />
                        <p-tag [value]="approvalCount() + ' Approval'" icon="pi pi-check-square" severity="secondary" />
                        <p-tag [value]="signedCount() + ' Signed'" icon="pi pi-verified" severity="secondary" />
                    </div>
            ...
            <div class="p-4 border border-surface rounded-2xl">
                <p-dataview [value]="filteredOpportunities()" [layout]="layout" [pt]="{ header: { class: 'hidden' } }">
