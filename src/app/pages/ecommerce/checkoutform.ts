            ...
            <div class="bg-surface-50 dark:bg-surface-800 border-b border-surface-200 dark:border-surface-700">
                <div class="max-w-7xl mx-auto p-6 xl:px-8">
                    <div class="flex items-center gap-3 mb-8">
                        <i class="pi pi-arrow-left text-surface-950 dark:text-surface-0 cursor-pointer hover:text-surface-700 dark:hover:text-surface-300"></i>
                    ...
                    <div class="xl:col-span-1">
                        <div class="bg-white dark:bg-surface-800 rounded-3xl shadow-xl p-8 space-y-6 xl:-mt-40 min-w-[340px]">
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <input type="email" pInputText [(ngModel)]="formData.email" class="w-full" />
                            </div>
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <input type="text" pInputText [(ngModel)]="formData.cardholderName" class="w-full" />
                            </div>
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <input type="text" pInputText [(ngModel)]="formData.taxId" class="w-full" />
                            </div>

                            <div class="flex flex-col gap-2">
                                <label class="text-surface-900 dark:text-surface-0 text-base">Discount code</label>
                                <input type="text" pInputText [(ngModel)]="formData.discountCode" class="w-full" />
                            </div>

                            <p-button [label]="'Pay $' + total.toFixed(2)" styleClass="w-full px-3 py-2 rounded-xl text-base font-medium" (onClick)="processPayment()" />
                        </div>
                    </div>
                </div>
            </div>
