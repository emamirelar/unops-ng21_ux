...
@Component({
    ...
    standalone: true,
    imports: [CommonModule, FormsModule, ButtonModule, CheckboxModule, TagModule, TextareaModule, DividerModule],
    template: `
            ...
            <div class="self-stretch p-4 sm:p-6 xl:p-8 flex flex-col items-end gap-6">
                <div class="self-stretch flex flex-col md:flex-row items-start gap-4 md:gap-8">
                    <div class="w-full md:w-[283px] flex flex-col gap-2">
                        ...
                        <div class="self-stretch text-surface-600 dark:text-surface-300 text-base font-normal leading-normal">Current status of the user account</div>
                    </div>
                ...
                <div class="self-stretch flex flex-col md:flex-row items-start gap-4 md:gap-8">
                    <div class="w-full md:w-[283px] flex flex-col gap-2">
                        ...
                        <div class="self-stretch text-surface-600 dark:text-surface-300 text-base font-normal leading-normal">Send invitation email to the user</div>
                    </div>
                ...
                <div class="self-stretch flex flex-col md:flex-row items-start gap-4 md:gap-8">
                    <div class="w-full md:w-[283px] flex flex-col gap-2">
                        ...
                        <div class="self-stretch text-surface-600 dark:text-surface-300 text-base font-normal leading-normal">Additional notes or comments about the user</div>
                    </div>
