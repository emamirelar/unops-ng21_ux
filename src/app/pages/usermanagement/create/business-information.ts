...
@Component({
    ...
    standalone: true,
    imports: [CommonModule, FormsModule, ButtonModule, InputTextModule, MultiSelectModule, SelectButtonModule, SliderModule, ToggleSwitchModule, DividerModule],
    template: `
            ...
            <div class="self-stretch p-4 sm:p-6 xl:p-8 flex flex-col items-end gap-6">
                <div class="self-stretch flex flex-col md:flex-row items-start gap-4 md:gap-8">
                    <div class="w-full md:w-[283px] flex flex-col gap-2">
                        ...
                        <div class="self-stretch text-surface-600 dark:text-surface-300 text-base font-normal leading-normal">The department you work in</div>
                    </div>
                ...
                <div class="self-stretch flex flex-col md:flex-row items-start gap-4 md:gap-8">
                    <div class="w-full md:w-[283px] flex flex-col gap-2">
                        ...
                        <div class="self-stretch text-surface-600 dark:text-surface-300 text-base font-normal leading-normal">Your current job title</div>
                    </div>
                ...
                <div class="self-stretch flex flex-col md:flex-row items-start gap-4 md:gap-8">
                    <div class="w-full md:w-[283px] flex flex-col gap-2">
                        ...
                        <div class="self-stretch text-surface-600 dark:text-surface-300 text-base font-normal leading-normal">Your work status</div>
                    </div>
                ...
                <div class="self-stretch flex flex-col md:flex-row items-start gap-4 md:gap-8">
                    <div class="w-full md:w-[283px] flex flex-col gap-2">
                        ...
                        <div class="self-stretch text-surface-600 dark:text-surface-300 text-base font-normal leading-normal">Whether hybrid work is available</div>
                    </div>
                ...
                <div class="self-stretch flex flex-col md:flex-row items-start gap-4 md:gap-8">
                    <div class="w-full md:w-[283px] flex flex-col gap-2">
                        ...
                        <div class="self-stretch text-surface-600 dark:text-surface-300 text-base font-normal leading-normal">Office address or location</div>
                    </div>
                ...
                <div class="self-stretch flex flex-col md:flex-row items-start gap-4 md:gap-8">
                    <div class="w-full md:w-[283px] flex flex-col gap-2">
                        ...
                        <div class="self-stretch text-surface-600 dark:text-surface-300 text-base font-normal leading-normal">Your salary range</div>
                    </div>
